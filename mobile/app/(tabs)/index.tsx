...
import { Plus, ShieldAlert, Heart, Phone } from 'lucide-react-native';

export default function DashboardScreen() {
  const { user, medicines, members, lowStockMedicines, expiringMedicines, deleteMedicine } = useAppStore();
    ...
    return (
      <SafeAreaView style={styles.elderContainer} edges={['top']}>
        ...
        <ScrollView contentContainerStyle={styles.elderScroll}>
          <TouchableOpacity style={styles.sosBigButton}>
            <ShieldAlert size={48} color="#ffffff" />
            <Text style={styles.sosBigText}>EMERGENCY SOS</Text>
            <Text style={styles.sosSubText}>Tap to call emergency helpline</Text>
          </TouchableOpacity>
